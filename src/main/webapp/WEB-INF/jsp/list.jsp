...
<%-- 멤버 엔티티에 폰 엔티티 목록이 포함되어 있으므로 member.getPhones() 의 카운트를 표시 --%>
...
<body>
	...
	<div class="container" style="text-align: center">
		...
		<form action="/jsp/list" name="search_keyword">
			<br> <select>
				<option value="이름">지인 이름</option>
				<option value="뒷자리">전화번호 뒷자리</option>
			</select> <input class="search" type="text" name="search_keyword" />
			<button type="button" class="btn btn-primary" id="serach">검색</button>
		</form>
	</div>
