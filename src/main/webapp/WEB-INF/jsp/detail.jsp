...
<body>
			...
			<tbody>
				<c:forEach var="list" items="${list}" varStatus="status">
					...
					<tr>
						...
						<td>${list.createdDateString}</td>
						<td>${list.modifiedDateString}</td>
						<td>
							<button type="button" class="btn btn btn-primary btn-sm" id="Modify" onClick="location.href='/jsp/numodify?telSeq=${list.telSeq}'">수정</button>
							<button type="button" class="btn btn btn-warning btn-sm" id="Delete" onClick="location.href='/ddelete?tel_seq=${list.telSeq}'">삭제</button>
						</td>
	...
	<div class="container">
		...
		<button type="button" class="btn btn-primary" id="register" onClick="location.href='/jsp/enroll?frndSeq=${member.frndSeq}'">등록</button>
